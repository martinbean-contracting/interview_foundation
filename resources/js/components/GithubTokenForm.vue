                ...
                <b-card>
                    ...
                    <template v-else>
                        ...
                        <p class="mb-0 small text-muted">
                            No token?
                            <a href="https://docs.github.com/en/free-pro-team@latest/github/authenticating-to-github/creating-a-personal-access-token" rel="external nofollow noopener" target="_blank">Click here</a>
